    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {fonts.map((value, index) => {
          return (
            <div key={index} className={`${value.font} flex flex-col justify-center items-center border py-5 rounded-md  hover:shadow-lg hover:border-black ${index == fontIndex && 'border-black'}`}
