...
const PhotoTalkEditor = () => {
  ...
  useEffect(() => {
    if (editingPhotoTalk) {
      ...
      setImages(editingPhotoTalk.images.map((url) => ({ id: url, url })));
    } else {
      setName('');
      setContent('');
      setPassword('');
  ...
  const handleImageUpload = (files: FileList | File[]) => {
    ...
    const newImages = fileArray.map((file) => {
      ...
      return { id: objectUrl, url: objectUrl, file };
    });
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col gap-2 p-4">
            ...
            {images.length === 0 ? (
              ...
              >
                <label
                  className={`flex flex-col items-center justify-center w-full py-8 border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 ${
                    isDragging
              ...
              <div className="flex flex-nowrap gap-2 overflow-x-auto py-2">
                <div
                  className="flex w-20 h-20 items-center justify-center border-2 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 flex-shrink-0"
                  onDragOver={handleDragOver}
                  onDragLeave={handleDragLeave}
                  onDrop={handleDrop}
                >
