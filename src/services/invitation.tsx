...
//청첩장 수정
export const updateInvitation = async ({ id, details }: { id: number, details: InvitationDetiail }) => {
  const { data } = await axiosInstance.put(API.INVITATIONS(id.toString()), details)
  return data
}